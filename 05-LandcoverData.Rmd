...
To read in the land cover dataset, navigate to [2015 Land Cover of Canada](https://open.canada.ca/data/en/dataset/4e615eae-b90c-420b-adee-2ca35896caf6), scroll down to **Data and Resources** and select either data labeled `web_service` and `WMS` (English) ##Should this the be TIFF file? You should be directing the user to the `Data` file. \## Extract the data download and save the file to your directory before applying `terra::rast()`.
...
#I stopped here. This is resulting in a 0x0 df??
