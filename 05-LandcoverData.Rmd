...
```{r}
# output_path <- "C:/Users/dimit/Birds Canada/Data/mauricie/landcover_crop.tif" ##This should not have your user names in the file path
...
OPTIONAL: To write the masked raster to your disk, you can use the `writeRaster()` function from `terra`. **This raster will be useful to complete [Chapter 7: Raster Summary Tools](07-RasterSummaryTools.Rmd)**. You must complete the above sections and save this raster to proceed with Chapter 7 unless you're using your own data. ##This is redundant to above
