...
-   Link NatureCounts data to land cover data for analysis
...
To read in the National Park polygons, navigate to [Places administered by Parks Canada](https://open.canada.ca/data/en/dataset/e1f0c975-f40c-4313-9be2-beb951e35f4e/resource/0744186a-449b-4f1f-9f1e-952a94c6d5ca) and save it to your directory before applying the `st_read()` function.
...
To read in the landcover dataset, navigate to [2015 Land Cover of Canada](https://open.canada.ca/data/en/dataset/4e615eae-b90c-420b-adee-2ca35896caf6)using and save it to your directory before applying `terra::rast()`.
