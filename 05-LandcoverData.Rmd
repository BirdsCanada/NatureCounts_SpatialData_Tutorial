...
Examine the categories of the cropped land cover raster. The `cats()` function displays the color (RGB) table that associates each class with a distinct color. Let's save this to our environment as a dataframe called **landcover_rgb** using the `as.data.frame()` function.
