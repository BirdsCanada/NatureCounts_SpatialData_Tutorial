...
For each point buffer, crop and mask the land cover data and calculate the class-level PLAND and ED. Store the result in a dataframe.
...
for (i in seq_len(nrow(mauricie_birds_buffer))) {
  ...
  lsm_landscape[[i]] <- crop(landcover, buffer_i) %>% 
    ...
    select(point_id, level, metric, value)
}
