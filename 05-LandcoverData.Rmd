...
###NOTE THIS MAP LOOKS REALLY WONGKY ON MY END ###
##Why do we assign the color ourselves. I think it would be easier if you let ggplot just pick random colour for each landcover_class. This would elimiate the need to keep the landcover_rgb dataframe which I think is somewhat confusing ###
...
####DELETED CODE. redundant with the previous section####
...
##DO WE NEED TO KNOW THIS?I WOULD SAY WE COULD END AT THE BUFFER TOOL SINCE THIS IS GOING TO BE MOST USEFUL###
