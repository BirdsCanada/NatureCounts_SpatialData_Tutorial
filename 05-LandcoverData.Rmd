...
landcover <- rast("data/landcover-2015-classification.tif")
...
```{r}
mauricie_birds_df <- read.csv("data/mauricie_birds_df.csv")
```
...
landscape_metrics_df <- mauricie_birds_sf %>%
  ...
  select(point_id, ed, np)  # Keep point_id, ed, and np columns
```
