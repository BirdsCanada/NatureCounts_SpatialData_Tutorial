...
Alternatively, if you wanted to calculate other landscape metrics across all buffers without grouping by Locality, you could apply the `calculate_lsm()` function a little differently. 
