...
Now let's combine the landscape-level metrics you derived from land cover with the NatureCounts summary data to assess how the metrics might influence species diversity.
