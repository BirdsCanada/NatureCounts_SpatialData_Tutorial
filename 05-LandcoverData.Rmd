...
-   Process land cover data (raster), including cropping and masking: [5.2 Crop & Mask Functions]
-   Load and interpret raster data color maps: [5.3 Raster Color Maps]
-   Combine NatureCounts data with land cover data for analysis: [5.4 Map & Extract Land Cover Data]
...
Combine the land cover RGB and land cover class dataframes with the NatureCounts dataframe.
