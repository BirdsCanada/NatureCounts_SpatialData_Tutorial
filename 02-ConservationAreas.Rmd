...
library(sf)
#library(terra)  ###I think these packages are not used. 
library(tidyverse)
#library(ggspatial)
library(leaflet)
...
Navigate to [Priority Places - Open Government Portal](https://open.canada.ca/data/en/dataset/91219d24-e877-4c8a-8bd2-b2b662e573e0). ##Dimitri: Please provide here some step by step instructions how to download. It isn't clear on the website and people might get confused which file to select##
