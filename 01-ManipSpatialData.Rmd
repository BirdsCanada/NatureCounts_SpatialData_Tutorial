...
Use the `format_dat` function to create date and day-of-year (doy) columns.
...
Let's search NatureCounts for the Ontario Breeding Bird Atlas (ONATLAS3PC) dataset to assess Wood Duck distribution across Ontario KBA's.The steps here are similar to those your used for Cedar Waxwing.
