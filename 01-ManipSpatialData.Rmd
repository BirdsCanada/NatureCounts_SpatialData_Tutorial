...
```{r}
kba_attributes <- read.csv("C:/Users/dimit/Birds Canada/NatureCounts_SpatialData_Tutorial/data/kba/provontario_kba/ontario_kba.csv")
```
...
```{}
gdb_path <- "C:/Users/dimit/Birds Canada/NatureCounts_SpatialData_Tutorial/data/priority_places/priorityplaces.gdb"
```
