...
Now that we've downloaded the temperature data and determined the mean temperature of each Priority Place, we can add in our NatureCounts data to visualize Cedar Waxwing distribution.
