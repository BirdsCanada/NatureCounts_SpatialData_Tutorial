...
Spatial data mapping is useful when exploring possible associations between species occurrences and environmental variables. Integrating diverse environmental datasets with NatureCounts data and creating maps can help inform species distribution models, delimit predictor variables, and provide us clever ways to communicate our data.

# 2.0 Learning Objectives

By the end of **Chapter 2 - Manipulating Spatial Data (Part 2)**, users will know how to:
...
**Data**: this tutorial incorporates historical weather data from Environment and Climate Change Canada (ECCC) with data from NatureCounts and the [Priority Places - Open Government Portal](https://open.canada.ca/data/en/dataset/91219d24-e877-4c8a-8bd2-b2b662e573e0).
...
*Example 4*: You would like to combine yearly temperature values (2006-2010) with yearly Cedar Waxwing observation counts across the Maritime provinces to explore possible trends and visualize the data using a spatio-temporal map. The summer monthds are an important egg-laying period for the Cedar Waxwing and mean temperature might affect the abundance of food in the later part of the summer for this species.
...
# 2.2 Preparing NatureCounts Data

If you haven't done so already in [Chapter 1](01-ManipSpatialData.Rmd), you can go ahead and download the NatureCounts data for the Cedar Waxwing.
...
Convert the NatureCounts data to a spatial object using the station coordinates:
...
# 2.3 Environmental Data Mapping
