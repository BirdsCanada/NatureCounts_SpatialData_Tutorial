...
2)  In the **Search** tab, select SENTINEL-2 and the appropriate time range to retrieve the following image. You can also copy/paste the product name into the search bar to find the image. 
