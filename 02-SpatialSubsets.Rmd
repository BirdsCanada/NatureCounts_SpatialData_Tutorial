...
```{r}
ontario_kba <- sf::st_read("data/ontario_kba.shp")
```
...
```{r}
kba_attributes <- read.csv("data/ontario_kba.csv")
```
...
```{r}
# st_write(wood_ducks_longpoint,"data/wood_ducks_longpoint.shp", driver = "ESRI Shapefile", delete_layer = TRUE)
```
