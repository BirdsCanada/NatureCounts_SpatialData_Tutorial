...
nc_query_table() #to see what is openly accessible. 
nc_query_table(username = "YOURUSERNAME") #to see what your personal account can access. For permission to sepcific datatable, contact naturecounts@birdscanada.org

rnest <- nc_query_table("Rnest")


life<-nc_query_table("SpeciesLifeHistory") #contains information on species life history traits

#Sample code how to access a species 3 generation length
...
##Start from the top and show the user how to download the data. Suggest selecting another dataset, as discussed. 
