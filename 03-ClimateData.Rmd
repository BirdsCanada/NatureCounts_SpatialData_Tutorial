...
# 3.1 Summarize NatureCounts Data
...
**Congratulations**! You've completed **Chapter 3 - Climate Data**. Here, you successfully combined NatureCounts data with vector and raster climate data in R. In [Chapter 4](04-EnvironmentalData.Rmd) you can explore how-to link NatureCounts observations with other environmental variables like elevation, landcover, and spectral indices.
