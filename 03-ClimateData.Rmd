...
# 3.0 Learning Objectives {#3.1_Learn}
...
After dowloading the WorldClim data to your subdirectory, list all the files in the raster stack by specifying the path to your folder (use `list.files` function) and read them into R using the `rast` function.
