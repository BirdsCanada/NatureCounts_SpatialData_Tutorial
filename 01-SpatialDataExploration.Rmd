...
# Module 1: Spatial Data Exploration

##### Author: Dimitrios Markou

Research analysis often starts with fundamental questions: *Where is the data and how can we best prepare it for analysis?* Understanding data types and how-to visualize them are key to how we interact with and interpret data and identify areas for conservation action. The [NatureCounts_SpatialData_Tutorial](#0) serves as a guide on how-to visualize and analyse NatureCounts, spatial, and environmental data in R to help users meet their conservation and research goals.
...
# 1.3 Spatial Data Exploration: Spatio-temporal mapping
...
**Congratulations!** You completed **Module 1: Spatial Data Exploration**. Here, you successfully visualized NatureCounts vector data over a wide spatial and temporal scale using a multi-panel plot. In [Module 2](02-ConservationAreas.Rmd), you can explore spatial data manipulation, apply geoprocessing functions, and visualize NatureCounts data within [Key Biodiversity Areas (KBAs)](https://kbacanada.org/about/) and [Priority Places - Open Government Portal](https://open.canada.ca/data/en/dataset/91219d24-e877-4c8a-8bd2-b2b662e573e0).
