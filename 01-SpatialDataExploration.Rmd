...
Exploring your data in a visual way is an important first step to any analysis. This chapter will give you a foundation understanding of how to work with your NatureCounts data spatially in R. This Chapter assumes that you have a basic understand of how to access your data from NatureCounts. The [NatureCounts Introductory R Tutorial](#link) is where you should start if you're new to the `naturecounts` R package. It explains how to access, view, filter, manipulate, and visualize NatureCounts data. We recommend reviewing this tutorial before proceeding.
...
Raster data files are typically stored with TIFF or GeoTIFF files with a *(.tif)* or *(.tiff)* extension. Raster data manipulation will be in covered in subsequent chapters (see [Incorporating Climate Data](provide%20link) and [Incorporating Environmental Data](provide%20link)).
...
Use the [format_dates](provide%20link) function to create date and day-of-year (doy) columns.
...
**Congratulations!** You completed **Chapter 1: Spatial Data Exploration**. Here, you successfully visualized NatureCounts vector data over a wide spatial and temporal scale using a multi-panel plot. In [Chapter 2](02-ConservationAreas.Rmd), you can explore spatial data manipulation, apply geoprocessing functions, and visualize NatureCounts data within [Key Biodiversity Areas (KBAs)](https://kbacanada.org/about/) and [Priority Places](https://open.canada.ca/data/en/dataset/91219d24-e877-4c8a-8bd2-b2b662e573e0).
