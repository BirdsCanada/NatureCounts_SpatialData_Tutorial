...
Raster data files are typically stored with TIFF or GeoTIFF files with a *(.tif)* or *(.tiff)* extension. Raster data manipulation will be in covered in subsequent chapters (see [Incorporating Climate Data](provide link) and [Incorporating Environmental Data](provide link)).
...
Use the [format_dates](provide link) function to create date and day-of-year (doy) columns.
