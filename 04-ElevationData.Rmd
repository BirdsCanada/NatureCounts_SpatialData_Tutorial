...
-   Process Digital Terrain Models (DTMs), including cropping and masking
-   Extract elevation data (raster values) at observation sites (vector points)
-   Combine NatureCounts data with elevation data for analysis
-   Access LiDAR-derived data products
...
For quick-access to the elevation data, download the .tif files from their URL using the hyperlinks below. If you wish to gain experience in how-to access LiDAR data yourself, follow the steps [at the end of this Chapter](#Lidar4.5).
...
# 4.2 DEM, DSM & DTM {#4.2DigitalElevationModels}
...
# 4.4 LiDAR Data Resources {#4.4LiDAR}
...
# 4.5 Manual Data Download {#4.5LiDAR}
