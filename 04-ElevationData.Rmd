...
For quick-access to the elevation data, specify your output directory and run the code chunk below to download the .tif files from their URL. This could take at least 5 min to download, so adjust the timeout limit accordingly. Otherwise, follow the steps below to access the data yourself using the LiDAR data platform.
