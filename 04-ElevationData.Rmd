...
OPTIONAL: To write the masked raster to your disk, you can use the `writeRaster()` function from `terra`. **This raster will be useful to complete Chapter 7: Raster Summary Statistics**. However, we have also uploaded this file to the repository data folder for your convenience.  
