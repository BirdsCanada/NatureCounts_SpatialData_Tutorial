...
```
OPTIONAL: To write the boundary as a shapefile to your disk, use the `st_write()` function. **The boundary files will be required to complete Chapter 5: Land Cover Data and Chapter 6: Satellite Imagery**. However, we have also uploaded this file to the repository data folder for your convenience.
...
>>>>>>> f6807e476700d9d742530b614af0371ad6076e0c
```
...
OPTIONAL: To write the masked raster to your disk, you can use the `writeRaster()` function from `terra`. **This raster will be useful to complete Chapter 7: Raster Summary Statistics**. You must complete the above sections and save this raster to proceed with Chapter 7.
