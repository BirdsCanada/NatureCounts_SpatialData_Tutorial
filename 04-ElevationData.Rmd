...
###I have not worked through the tutorial with the ebird data. Could you please do this and check that it works here and in other chapters. Or remove reference to ebird here. For example, summarize total count for each species at each Atlas Block. Does this work??###
...
# 4.4 Map Digital Elevation Data {#4.4Map-Extract}###Is extract the correct term??
...
###Ensure that in each chapter the RasterSummaryTools.Rmd is referenced correctly as SummarytTools.Rmd###
