...
**Note: You should store the DTM's in their own folder after download. The code below will produce an error if there are other .tiff files in your working directory.**
