...
**Step 1**: Navigate to the [Lidar](https://www.donneesquebec.ca/recherche/fr/dataset/produits-derives-de-base-du-lidar) data site. Under **Données et ressources** \> **Carte interactive** \> **Forêt ouverte** select (**Explorer \> Accéder**) next to the **Téléchargement** option to explore the Lidar tiles on an interactive map.
