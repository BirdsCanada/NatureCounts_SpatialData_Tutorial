...
<<<<<<< HEAD
In [Chapter 3](03-ClimateData.Rmd), you processed vector and raster climate data, linked them with NatureCounts data, and created maps. In this tutorial, you will process Digital Terrain Models, apply crop, mask, and reclassification procedures, and extract elevation values to link with your NatureCounts data.

**After downloading the necessary packages be sure to follow the Preliminary Steps section before proceeding with the tutorial. It helps you preprocess the National Park boundary and NatureCounts data which are required for this lesson.**
=======
...
>>>>>>> 039f585ac586cf8f1e7f9077bf1a331788257c81
...
##Dimitri
##Preliminary Steps Are AT THE BOTTOM?
##I still can't figure out how to get these data. Can we provide english here. There is an option to tanlsate the site and that might just be easier than going between languages. 
