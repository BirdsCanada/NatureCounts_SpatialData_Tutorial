...
-   Process Digital Terrain Models (DTMs), including cropping and masking: [4.3 Crop & Mask Functions]
-   Extract elevation data (raster values) at observation sites (vector points): [4.4 Map & Extract Digital Elevation Data]
