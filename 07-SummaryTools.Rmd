...
**This chapter builds on Chapters 4-6 of the Spatial_Data_Tutorial, and uses the National Park boundary and NatureCounts data downloaded in section 4.1 Data Setup from [Chapter 4: Elevation Data](04-ElevationData.Rmd). For quick access, the NatureCounts data linked with environmental covariates are available for download via the [Google Drive](https://drive.google.com/drive/folders/1gLUC6fROl4kNBvTGselhZif-arPexZbY?usp=sharing) data folder. If you wish to gain experience in how to download, process, and save the environmental layers yourself, return to the earlier chapters of this tutorial series and explore our Additional Resources.**

# 7.0 Learning Objectives {#7.0LearningObjectives}

By the end of **Chapter 7 - Summary Statistics**, users will know how to:

-   Create and visualize NatureCounts data summaries using environmental covariates in four key examples: Landscape Association Plot, Species Rank Plot, Elevation Plot, and NDVI Plot
