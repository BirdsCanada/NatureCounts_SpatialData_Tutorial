...
-   Plot true color composites of satellite imagery: [6.1 Color Composite Images]
-   Create digital water masks and calculate NDWI and NDVI indices: [6.2 Calculate Spectral Indices](#6.2SpectralIndices)
-   Combine NatureCounts data with spectral index values for analysis: [6.3 Map & Extract Spectral Indices]
-   Explore and download satellite imagery data: [6.4 Copernicus Data Download]
