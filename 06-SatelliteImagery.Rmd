...
**To proceed with this tutorial, download the necessary packages in [6.0 Learning Objectives](#6.0LearningObjectives) and complete section 4.1 Data Setup from [Chapter 4: Elevation Data](04-ElevationData.Rmd)**. **It helps you download the National Park boundary and NatureCounts data which are required for this lesson. Alternatively, you can access these files in the [Git repository data folder](https://github.com/BirdsCanada/NatureCounts_SpatialData_Tutorial/tree/d83eed714373048c8f9fdb4ea4a17f1fd4bef3f7/Data) or the [Google Drive data folder](https://drive.google.com/drive/folders/1gLUC6fROl4kNBvTGselhZif-arPexZbY?usp=sharing).**

# 6.0 Learning Objectives {#6.0LearningObjectives}

By the end of **Chapter 6 - SatelliteImagery**, users will know how to:

-   Plot true and false color composites of satellite imagery: [6.1 Color Composite Images](#6.1ColorComposites)
-   Create digital water masks and calculate NDWI and NDVI indices: [6.2 Calculate Spectral Indices](#6.2SpectralIndices)
-   Combine NatureCounts data with spectral index values for analysis: [6.3 Map & Extract Spectral Indices](#6.3Map-Extract)
-   Explore and download satellite imagery data: [6.4 Copernicus Data Download](#6.4CopernicusDataDownload)
...
The National Park boundary and NatureCounts data are available for download via the [Git repository](https://github.com/BirdsCanada/NatureCounts_SpatialData_Tutorial.git) or [Google Drive](https://drive.google.com/drive/folders/1gLUC6fROl4kNBvTGselhZif-arPexZbY?usp=sharing) data folders. Quick access to the Copernicus satellite data is also available but only through [Google Drive](https://drive.google.com/drive/folders/1gLUC6fROl4kNBvTGselhZif-arPexZbY?usp=sharing) due to file size limitations. Once there, download and extract the **copernicus_R10m** (.*zip)* file to your directory. If you wish to gain experience in how-to access Copernicus satellite imagery yourself, follow the steps [at the end of this Chapter](#6.1CopernicusDataDownload).
...
Read in the National Park boundary you saved or downloaded from [Chapter 4: Elevation Data](04-ElevationData.Rmd), the [Git repository](https://github.com/BirdsCanada/NatureCounts_SpatialData_Tutorial.git) or, the [Google Drive](https://drive.google.com/drive/folders/1gLUC6fROl4kNBvTGselhZif-arPexZbY?usp=sharing) data folder.
...
Read in the NatureCounts data you saved or downloaded from [Chapter 4: Elevation Data](04-ElevationData.Rmd), the [Git repository](https://github.com/BirdsCanada/NatureCounts_SpatialData_Tutorial.git) or, the [Google Drive](https://drive.google.com/drive/folders/1gLUC6fROl4kNBvTGselhZif-arPexZbY?usp=sharing) data folder.
...
**Congratulations**! You completed **Chapter 6 - Satellite Imagery**. In this chapter, you successfully 1) downloaded satellite imagery data 2) calculated NDVI and NDWI spectral indices and 3) extracted spectral index values over vector data points. In [Chapter 7](07-RasterSummaryTools.Rmd), you can explore simple functions that will help you reclassify raster objects and calculate raster summary statistics.
...
```{r}
request_url <- GET("https://modis.ornl.gov/rst/api/v1/MOD13Q1/subset?latitude=46.787474&longitude=-72.980392&band=250m_16_days_NDVI&startDate=A2011129&endDate=A2011209&kmAboveBelow=15&kmLeftRight=17")

dates <- content(request_url)$dates
