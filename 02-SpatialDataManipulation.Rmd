---
title: "02-SpatialDataManipulation"
...
# Module 2: Spatial Data Manipulation: KBA's and Priority Places
...
By the end of **Module 2 - Spatial Data Manipulation**, users will know how to:
...
# 2.1 Reading in spatial data: Key Biodiversity Areas
...
# 2.2 Visualizing spatial data in R
...
# 2.3 Reading in NatureCounts data
...
**Congratulations**! You have completed **Module 2 - Spatial Data Manipulation: KBA's and Priority Places**. Here, you've successfully filtered and visualized NatureCounts data using spatio-temporal, KBA, and Priority Place maps. In [Module 3](03-ClimateData.Rmd), you will explore more spatial data visualization while linking climate data to NatureCounts observations.